...
def parse_args():
    ...
    parser.add_argument('--learning_rate', default=0.00006, type=float, help='initial learning rate')
...
def main(args):
    ...
    exp_dir.mkdir(exist_ok=True)
    checkpoints_dir = exp_dir.joinpath('checkpoints_pretrain_ptmae_epoch10_newlr/')
